...
import { Intro, InfoHD1, InfoHD2, InfoHD3, InfoHD4, LogoHD } from "../assets";
    ...
    return (
        <div className="bg-white w-full mt-24">
            ...
            <div ref={sectionRefs[0]} className="div">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 md:gap-10 h-[300px] md:h-[500px]">
                        ...
                        >
                            <p className=" font-notosans font-light leading-relaxed md:text-lg text-textlight">
                                Es una herramienta de exigibilidad extrainstitucional del derecho, a un trabajo digno y de calidad para las mujeres trabajadoras de la industria de la indumentaria en México. <br /> <br />
                                Este proyecto representó una oportunidad para establecer una narrativa visual que conectara los valores y objetivos de la herramienta con la audiencia, desde la conceptualización de la identidad hasta su implementación en materiales gráficos.
                ...
                >
                    {/* Imagen 1 */}
                    <div className="bg-hilandored flex items-center justify-center px-16 py-10 lg:py-14 xl:py-40">
            ...
            <div className="div">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 w-full "  >
                    {/* Imagen 3 */}
                    <div className="bg-hilandoblue flex items-center justify-center px-20 lg:py-14 xl:py-30">
                        <motion.div className="div"
                            ref={sectionRefs[1]}
                            initial={{ opacity: 0, y: 50 }}
...
<div className=" bg-hilandocream justify-center">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 w-full">
                ...
                {/* Imagen 5 */}
                <div className="bg-hilandoyellow flex items-center justify-center px-10 py-5">
                    <motion.div
                        ref={sectionRefs[3]}
                        className="div"
                        initial={{ opacity: 0, y: 50 }}
                        ...
                        transition={{ delay: 0.3, duration: 1 }}
                    >
                        <img src={InfoHD3} alt="Imagen 3" className="w-full mt-4" />
                    </motion.div>
                </div>
                ...
                <div className="bg-hilandoyellow  flex items-center justify-center px-10 py-5">
                    <motion.div
                        ...
                        transition={{ delay: 0.3, duration: 1 }}
                    >
                        <img src={InfoHD4} alt="Imagen 4" className="w-full mt-4" />
                    </motion.div>
                </div>
            </div>
        </div>
