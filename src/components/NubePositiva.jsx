...
import palabras from "../data/palabras_positivas.json"; // Ajusta el path a tu archivo JSON
...
const NubePositiva = () => {
  ...
  useEffect(() => {
    ...
    const baseColor = { r: 39, g: 102, b: 133 }; // RGB para #276685
    ...
    const getColorBasedOnFrequency = (weight) => {
      ...
      const r = baseColor.r + (212 - baseColor.r) * ratio; // Interpolar entre el color base y blanco (255)
      const g = baseColor.g + (224 - baseColor.g) * ratio;
      const b = baseColor.b + (231 - baseColor.b) * ratio;
